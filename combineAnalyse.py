...
sessions = ["1056"]
#add_sessions_to_combined(sessions, "Complex", "21_11_2023", "22_11_2023")
#combine_head_angle_calibration()
combine_all('Crossing', "05_12_2023")
...
'''df_PWScalibration_results = pd.DataFrame()
